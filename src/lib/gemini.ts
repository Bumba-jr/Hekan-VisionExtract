        ...
        parts: [
          {
            ...
            - RESOLVE DITTO MARKS: If you see "11", "''", or any symbol indicating "same as above" in any column (especially in Payment Info or Amount), you MUST replace it with the actual value from the row immediately above it.
