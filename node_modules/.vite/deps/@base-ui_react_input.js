import {
  useControlled
} from "./chunk-CQXWOKYQ.js";
import {
  useRegisteredLabelId
} from "./chunk-I65EFWNO.js";
import {
  useTimeout
...
import {
  mergeProps
} from "./chunk-E7LWGLDL.js";
import {
  __export,
  __toESM
} from "./chunk-2TUXWMP5.js";

// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/input/Input.js
var React19 = __toESM(require_react(), 1);

// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/index.parts.js
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/root/FieldRoot.js
var React8 = __toESM(require_react(), 1);

// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/root/FieldRootContext.js
var React = __toESM(require_react(), 1);

// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/control/FieldControlDataAttributes.js
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/utils/constants.js
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/fieldset/root/FieldsetRootContext.js
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/form/FormContext.js
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/labelable-provider/LabelableProvider.js
var React5 = __toESM(require_react(), 1);

// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/labelable-provider/LabelableContext.js
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/root/useFieldValidation.js
var React6 = __toESM(require_react(), 1);

// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/utils/getCombinedFieldValidityData.js
...
function useFieldValidation(params) {
  ...
  const getValidationProps = React6.useCallback((externalProps = {}) => mergeProps(getDescriptionProps, state.valid === false ? {
    "aria-invalid": true
  } : EMPTY_OBJECT, externalProps), [getDescriptionProps, state.valid]);
  const getInputValidationProps = React6.useCallback((externalProps = {}) => mergeProps({
    onChange(event) {
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/root/useFieldControlRegistration.js
...
function useFieldControlRegistration(params) {
  ...
  const activeFieldControlSourceRef = React7.useRef(null);
  const registrationRef = React7.useRef(null);
  const fallbackControlRef = React7.useRef(null);
  ...
  function deleteRegistration(id = ((_a) => (_a = registrationRef.current) == null ? void 0 : _a.id)()) {
    if (id) {
  ...
  useIsoLayoutEffect(() => {
    ...
    return () => {
      var _a;
      const id = (_a = registrationRef.current) == null ? void 0 : _a.id;
      if (id) {
        fields.delete(id);
      }
    };
  ...
  return useStableCallback((source, registration) => {
    ...
    const previousId = (_a = registrationRef.current) == null ? void 0 : _a.id;
...
var FieldRootInner = React8.forwardRef(function FieldRootInner2(componentProps, forwardedRef) {
  const {
    errors,
  ...
  const [touchedState, setTouchedUnwrapped] = React8.useState(false);
  const [dirtyState, setDirtyUnwrapped] = React8.useState(false);
  const [filled, setFilled] = React8.useState(false);
  const [focused, setFocused] = React8.useState(false);
  const dirty = dirtyProp ?? dirtyState;
  const touched = touchedProp ?? touchedState;
  const markedDirtyRef = React8.useRef(false);
  ...
  const [validityData, setValidityData] = React8.useState({
    state: DEFAULT_VALIDITY_STATE,
    error: "",
    errors: [],
    value: null,
  ...
  const handleImperativeValidate = React8.useCallback(() => {
    markedDirtyRef.current = true;
  ...
  React8.useImperativeHandle(actionsRef, () => ({
...
var FieldRoot = React8.forwardRef(function FieldRoot2(componentProps, forwardedRef) {
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/label/FieldLabel.js
var React9 = __toESM(require_react(), 1);

// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/labelable-provider/useLabel.js
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/label/FieldLabel.js
var FieldLabel = React9.forwardRef(function FieldLabel2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/error/FieldError.js
...
var FieldError = React10.forwardRef(function FieldError2(componentProps, forwardedRef) {
  const {
    render,
    id: idProp,
    className,
  ...
  const errorRef = React10.useRef(null);
  const [lastRenderedMessage, setLastRenderedMessage] = React10.useState(null);
  const [lastRenderedMessageKey, setLastRenderedMessageKey] = React10.useState(null);
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/description/FieldDescription.js
var React11 = __toESM(require_react(), 1);
var FieldDescription = React11.forwardRef(function FieldDescription2(componentProps, forwardedRef) {
  const {
    render,
    id: idProp,
    className,
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/control/FieldControl.js
var React14 = __toESM(require_react(), 1);

// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/root/useRegisterFieldControl.js
...
function useRegisterFieldControl(controlRef, params) {
  ...
  const sourceRef = React12.useRef(null);
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/labelable-provider/useLabelableId.js
...
function useLabelableId(params = {}) {
  ...
  const hasRegisteredRef = React13.useRef(false);
  const hadExplicitIdRef = React13.useRef(id != null);
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/control/FieldControl.js
var FieldControl = React14.forwardRef(function FieldControl2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
  ...
  useIsoLayoutEffect(() => {
    ...
    if (((_a = validation.inputRef.current) == null ? void 0 : _a.value) || hasExternalValue && valueProp !== "") {
      setFilled(true);
  ...
  const getFieldValue = useStableCallback(() => {
    var _a;
    return (_a = validation.inputRef.current) == null ? void 0 : _a.value;
  });
...
// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/validity/FieldValidity.js
...
var FieldValidity = function FieldValidity2(props) {
  ...
  const combinedFieldValidityData = React15.useMemo(() => getCombinedFieldValidityData(validityData, invalid), [validityData, invalid]);
  const isInvalid = combinedFieldValidityData.state.valid === false;
  const {
    transitionStatus
  } = useTransitionStatus(isInvalid);
  const fieldValidityState = React15.useMemo(() => {
    return {
  ...
  return (0, import_jsx_runtime4.jsx)(React15.Fragment, {
    children: children(fieldValidityState)
  });
};
if (true) FieldValidity.displayName = "FieldValidity";

// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/item/FieldItem.js
var React18 = __toESM(require_react(), 1);

// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/field/item/FieldItemContext.js
var React16 = __toESM(require_react(), 1);
var FieldItemContext = React16.createContext({
  disabled: false
});
if (true) FieldItemContext.displayName = "FieldItemContext";

// node_modules/.pnpm/@base-ui+react@1.4.0_@date-fns+tz@1.4.1_date-fns@4.1.0_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@base-ui/react/esm/checkbox-group/CheckboxGroupContext.js
var React17 = __toESM(require_react(), 1);
var CheckboxGroupContext = React17.createContext(void 0);
if (true) CheckboxGroupContext.displayName = "CheckboxGroupContext";
function useCheckboxGroupContext(optional = true) {
  const context = React17.useContext(CheckboxGroupContext);
...
var FieldItem = React18.forwardRef(function FieldItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const fieldItemContext = React18.useMemo(() => ({
    disabled
  }), [disabled]);
  const element = useRenderElement("div", componentProps, {
    ref: forwardedRef,
...
var Input = React19.forwardRef(function Input2(props, forwardedRef) {
  return (0, import_jsx_runtime6.jsx)(index_parts_exports.Control, {
    ref: forwardedRef,
    ...props
  });
});
